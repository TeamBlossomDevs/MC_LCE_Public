...
void Item::staticCtor()
{
	...
	Item::sword_copper      = ( new WeaponItem(sword_copper_Id - 256, _Tier::COPPER) )         ->setBaseItemTypeAndMaterial(eBaseItemType_sword,   eMaterial_copper)->setIconName(L"swordCopper")->setDescriptionId(IDS_ITEM_SWORD_IRON)->setUseDescriptionId(IDS_DESC_SWORD);
	Item::sword_netherite   = ( new WeaponItem(sword_netherite_Id - 256, _Tier::NETHERITE) )    ->setBaseItemTypeAndMaterial(eBaseItemType_sword,   eMaterial_netherite)->setIconName(L"swordNetherite")->setDescriptionId(IDS_ITEM_SWORD_DIAMOND)->setUseDescriptionId(IDS_DESC_SWORD);	
	...
	Item::shovel_copper     = ( new ShovelItem(shovel_copper_Id - 256, _Tier::COPPER) )         ->setBaseItemTypeAndMaterial(eBaseItemType_shovel,  eMaterial_copper)->setIconName(L"shovelCopper")->setDescriptionId(IDS_ITEM_SHOVEL_IRON)->setUseDescriptionId(IDS_DESC_SHOVEL);
	Item::shovel_netherite  = ( new ShovelItem(shovel_netherite_Id - 256, _Tier::NETHERITE) )   ->setBaseItemTypeAndMaterial(eBaseItemType_shovel,  eMaterial_netherite)->setIconName(L"shovelNetherite")->setDescriptionId(IDS_ITEM_SHOVEL_DIAMOND)->setUseDescriptionId(IDS_DESC_SHOVEL);
	...
	Item::pickAxe_copper    = ( new PickaxeItem(pickAxe_copper_Id - 256, _Tier::COPPER) )       ->setBaseItemTypeAndMaterial(eBaseItemType_pickaxe, eMaterial_copper)->setIconName(L"pickaxeCopper")->setDescriptionId(IDS_ITEM_PICKAXE_IRON)->setUseDescriptionId(IDS_DESC_PICKAXE);
	Item::pickAxe_netherite = ( new PickaxeItem(pickAxe_netherite_Id - 256, _Tier::NETHERITE) ) ->setBaseItemTypeAndMaterial(eBaseItemType_pickaxe, eMaterial_netherite)->setIconName(L"pickaxeNetherite")->setDescriptionId(IDS_ITEM_PICKAXE_DIAMOND)->setUseDescriptionId(IDS_DESC_PICKAXE);
	...
	Item::hatchet_copper    = ( new HatchetItem(hatchet_copper_Id - 256, _Tier::COPPER) )       ->setBaseItemTypeAndMaterial(eBaseItemType_hatchet, eMaterial_copper)->setIconName(L"hatchetCopper")->setDescriptionId(IDS_ITEM_HATCHET_IRON)->setUseDescriptionId(IDS_DESC_HATCHET);
	Item::hatchet_netherite = ( new HatchetItem(hatchet_netherite_Id - 256, _Tier::NETHERITE) ) ->setBaseItemTypeAndMaterial(eBaseItemType_hatchet, eMaterial_netherite)->setIconName(L"hatchetNetherite")->setDescriptionId(IDS_ITEM_HATCHET_DIAMOND)->setUseDescriptionId(IDS_DESC_HATCHET);
	...
	Item::hoe_copper        = ( new HoeItem(hoe_copper_Id - 256, _Tier::COPPER) )               ->setBaseItemTypeAndMaterial(eBaseItemType_hoe,     eMaterial_copper)->setIconName(L"hoeCopper")->setDescriptionId(IDS_ITEM_HOE_IRON)->setUseDescriptionId(IDS_DESC_HOE);
	Item::hoe_netherite     = ( new HoeItem(hoe_netherite_Id - 256, _Tier::NETHERITE) )         ->setBaseItemTypeAndMaterial(eBaseItemType_hoe,     eMaterial_netherite)->setIconName(L"hoeNetherite")->setDescriptionId(IDS_ITEM_HOE_DIAMOND)->setUseDescriptionId(IDS_DESC_HOE);
	...
	Item::helmet_copper      = static_cast<ArmorItem *>((new ArmorItem(helmet_copper_Id - 256, ArmorItem::ArmorMaterial::CHAIN, 1, ArmorItem::SLOT_HEAD))->setBaseItemTypeAndMaterial(eBaseItemType_helmet, eMaterial_copper)->setIconName(L"helmetChain")->setDescriptionId(IDS_ITEM_HELMET_IRON)->setUseDescriptionId(IDS_DESC_HELMET_IRON));
	Item::chestplate_copper  = static_cast<ArmorItem *>((new ArmorItem(chestplate_copper_Id - 256, ArmorItem::ArmorMaterial::CHAIN, 1, ArmorItem::SLOT_TORSO))->setBaseItemTypeAndMaterial(eBaseItemType_chestplate, eMaterial_copper)->setIconName(L"chestplateChain")->setDescriptionId(IDS_ITEM_CHESTPLATE_IRON)->setUseDescriptionId(IDS_DESC_CHESTPLATE_IRON));
	Item::leggings_copper    = static_cast<ArmorItem *>((new ArmorItem(leggings_copper_Id - 256, ArmorItem::ArmorMaterial::CHAIN, 1, ArmorItem::SLOT_LEGS))->setBaseItemTypeAndMaterial(eBaseItemType_leggings, eMaterial_copper)->setIconName(L"leggingsChain")->setDescriptionId(IDS_ITEM_LEGGINGS_IRON)->setUseDescriptionId(IDS_DESC_LEGGINGS_IRON));
	Item::boots_copper       = static_cast<ArmorItem *>((new ArmorItem(boots_copper_Id - 256, ArmorItem::ArmorMaterial::CHAIN, 1, ArmorItem::SLOT_FEET))->setBaseItemTypeAndMaterial(eBaseItemType_boots, eMaterial_copper)->setIconName(L"bootsChain")->setDescriptionId(IDS_ITEM_BOOTS_IRON)->setUseDescriptionId(IDS_DESC_BOOTS_IRON));

	Item::helmet_netherite      = static_cast<ArmorItem *>((new ArmorItem(helmet_netherite_Id - 256, ArmorItem::ArmorMaterial::NETHERITE, 1, ArmorItem::SLOT_HEAD))->setBaseItemTypeAndMaterial(eBaseItemType_helmet, eMaterial_netherite)->setIconName(L"helmetNetherite")->setDescriptionId(IDS_ITEM_HELMET_DIAMOND)->setUseDescriptionId(IDS_DESC_HELMET_DIAMOND));
	Item::chestplate_netherite  = static_cast<ArmorItem *>((new ArmorItem(chestplate_netherite_Id - 256, ArmorItem::ArmorMaterial::NETHERITE, 1, ArmorItem::SLOT_TORSO))->setBaseItemTypeAndMaterial(eBaseItemType_chestplate, eMaterial_netherite)->setIconName(L"chestplateNetherite")->setDescriptionId(IDS_ITEM_CHESTPLATE_DIAMOND)->setUseDescriptionId(IDS_DESC_CHESTPLATE_DIAMOND));
	Item::leggings_netherite    = static_cast<ArmorItem *>((new ArmorItem(leggings_netherite_Id - 256, ArmorItem::ArmorMaterial::NETHERITE, 1, ArmorItem::SLOT_LEGS))->setBaseItemTypeAndMaterial(eBaseItemType_leggings, eMaterial_netherite)->setIconName(L"leggingsNetherite")->setDescriptionId(IDS_ITEM_LEGGINGS_DIAMOND)->setUseDescriptionId(IDS_DESC_LEGGINGS_DIAMOND));
	Item::boots_netherite       = static_cast<ArmorItem *>((new ArmorItem(boots_netherite_Id - 256, ArmorItem::ArmorMaterial::NETHERITE, 1, ArmorItem::SLOT_FEET))->setBaseItemTypeAndMaterial(eBaseItemType_boots, eMaterial_netherite)->setIconName(L"bootsNetherite")->setDescriptionId(IDS_ITEM_BOOTS_DIAMOND)->setUseDescriptionId(IDS_DESC_BOOTS_DIAMOND));
	...
	Item::copperIngot    = ( new Item(copperIngot_Id - 256) )    ->setIconName(L"ingotCopper")->setBaseItemTypeAndMaterial(eBaseItemType_treasure, eMaterial_copper)->setDescriptionId(IDS_ITEM_INGOT_IRON)->setUseDescriptionId(IDS_DESC_INGOT);
	Item::netheriteIngot = ( new Item(netheriteIngot_Id - 256) ) ->setIconName(L"ingotNetherite")->setBaseItemTypeAndMaterial(eBaseItemType_treasure, eMaterial_netherite)->setDescriptionId(IDS_ITEM_INGOT_IRON)->setUseDescriptionId(IDS_DESC_INGOT);
	Item::netheriteScrap = ( new Item(netheriteScrap_Id - 256) ) ->setIconName(L"netherite_scrap")->setBaseItemTypeAndMaterial(eBaseItemType_treasure, eMaterial_netherite)->setDescriptionId(IDS_ITEM_INGOT_IRON)->setUseDescriptionId(IDS_DESC_INGOT);
