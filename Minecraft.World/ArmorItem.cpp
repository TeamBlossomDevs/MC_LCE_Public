...
const int _ArmorMaterial::copperArray[] = {3, 5, 4, 3};
const int _ArmorMaterial::netheriteArray[] = {6, 8, 5, 3};
...
const _ArmorMaterial *_ArmorMaterial::COPPER = new _ArmorMaterial(15, _ArmorMaterial::copperArray, 12);
const _ArmorMaterial *_ArmorMaterial::NETHERITE = new _ArmorMaterial(45, _ArmorMaterial::netheriteArray, 16);
