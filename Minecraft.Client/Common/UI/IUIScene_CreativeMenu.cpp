...
void IUIScene_CreativeMenu::staticCtor()
{
	...
	DEF(eCreativeInventory_BuildingBlocks)
		...
		ITEM_AUX(Tile::wood_Id,TreeTile::CHERRY_TRUNK)
		...
		ITEM_AUX(Tile::treeTrunk_Id, TreeTile::CHERRY_TRUNK)
		ITEM(Tile::gravel_Id)
...
//		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::WOOD_SLAB)
	...
	DEF(eCreativeInventory_ToolsArmourWeapons)
		...
		ITEM(Item::helmet_copper_Id)
		ITEM(Item::chestplate_copper_Id)
		ITEM(Item::leggings_copper_Id)
		ITEM(Item::boots_copper_Id)
		ITEM(Item::sword_copper_Id)
		ITEM(Item::shovel_copper_Id)
		ITEM(Item::pickAxe_copper_Id)
		ITEM(Item::hatchet_copper_Id)
		ITEM(Item::hoe_copper_Id)

		ITEM(Item::helmet_netherite_Id)
		ITEM(Item::chestplate_netherite_Id)
		ITEM(Item::leggings_netherite_Id)
		ITEM(Item::boots_netherite_Id)
		ITEM(Item::sword_netherite_Id)
		ITEM(Item::shovel_netherite_Id)
		ITEM(Item::pickAxe_netherite_Id)
		ITEM(Item::hatchet_netherite_Id)
		ITEM(Item::hoe_netherite_Id)
